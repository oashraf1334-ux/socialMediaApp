...
export abstract class DatabaseReposetories<TDocument> {
    ...
    async updateOne({
        ...
        update,
        options
    }:{filter:RootFilterQuery<TDocument>;update:UpdateQuery<TDocument>;options?:MongooseUpdateQueryOptions<TDocument>|null;}):Promise<UpdateWriteOpResult>{
